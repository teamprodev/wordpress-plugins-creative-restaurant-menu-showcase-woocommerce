...
window.dzsrst_prepare_footer_player = function(){
    jQuery('*[name=dzsrst_footer_featured_media]').val('fake');
    jQuery('*[name=dzsrst_footer_vpconfig]').val('footer-wave');
    jQuery('*[name=dzsrst_footer_type]').val('fake');
    jQuery('*[name=dzsrst_footer_vpconfig]').trigger('change');
}