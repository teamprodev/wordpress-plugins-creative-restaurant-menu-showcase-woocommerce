    ...
    this.each(function () {
      ...
      function init() {
        ...
        if (o.settings_mode == 'horizontal') {
          ...
          _theTarget.after(_theTarget.clone());
          _theTarget.prev().addClass('cloner cloner-before');
          _theTarget.next().addClass('cloner cloner-after');
...
jQuery(document).ready(function ($) {
  ...
  // console.log('.dzsparallaxer.auto-init - ', $('.dzsparallaxer.auto-init'));
